...
public class GuiFriendsList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        codeEntry = new GuiTextField(this.fontRendererObj, this.width / 2 - 80, this.height / 2 - 50, 160, 20);
        displayEntry = new GuiTextField(this.fontRendererObj, this.width / 2 - 80, this.height / 2 + 0, 160, 20);
    }
