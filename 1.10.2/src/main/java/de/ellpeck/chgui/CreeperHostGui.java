...
@Mod(modid = CreeperHostGui.MOD_ID, name = CreeperHostGui.NAME, version = CreeperHostGui.VERSION, clientSideOnly = true, acceptableRemoteVersions="*", acceptedMinecraftVersions = "1.8,1.8.8,1.8.9,1.9.4,1.10.2,1.11.2")
