...
//import java.util.*;
//
//public class GuiServerInfo extends Screen
//{
...
//        try
//        {
//            if (MineTogether.instance.getQueryGetter().getExtendedServerData() == null)
//            {
//                return false;
//            }
//
//            Map<String, Double> tpsInfo = MineTogether.instance.getQueryGetter().getExtendedServerData().getTPS(minecraft.player.dimension);
...
//
//            Map<String, Integer> entities = MineTogether.instance.getQueryGetter().getExtendedServerData().getEntitiesInDimension(Minecraft.getInstance().world.getDimension());
...
//                        k = this.minecraft.fontRenderer.getStringWidth(subStr);
//                        i = Math.max(i, k);
//                    }
//
