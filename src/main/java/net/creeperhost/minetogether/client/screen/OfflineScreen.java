...
public class OfflineScreen extends Screen
{
    ...
    public void init()
    {
        ...
        while (matcher.find())
        {
            ...
            else component = component.deepCopy().append(link);
        }
        ...
        this.buttons.add(acceptButton = new Button((width / 2) - 40, height - 40, 80, 20, new StringTextComponent("Continue"), (b) ->
        {
        ...
        buttons.add(checkBox = new CheckboxButton( (width / 2) - (font.getStringWidth("Do not show this screen again") / 2), height - 80, 150, 20, new StringTextComponent("Do not show this screen again"), true));
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(matrixStack, minecraft.fontRenderer, "MineTogether is in offline mode", width / 2, 10, -1);
        int start = 30;
