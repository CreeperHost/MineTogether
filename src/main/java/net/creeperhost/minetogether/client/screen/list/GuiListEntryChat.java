...
public class GuiListEntryChat extends GuiListEntry
{
    ...
    {
        super.render(matrixStack, slotIndex, y, x, listWidth, slotHeight, mouseX, mouseY, isSelected, p_render_9_);
        this.mc.fontRenderer.drawString(matrixStack, component.getString(), x + 5, y + 5, 16777215);
    }
}
