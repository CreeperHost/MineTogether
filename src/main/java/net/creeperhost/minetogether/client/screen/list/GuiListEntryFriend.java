...
public class GuiListEntryFriend extends GuiListEntry
{
    ...
    public void render(int slotIndex, int y, int x, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected, float p_render_9_)
    {
        ...
        this.mc.fontRenderer.drawString(new StringTextComponent(TextFormatting.GRAY + (friend.isAccepted() ? (profile != null && profile.isOnline() ? "Online" : "Offline") : "Pending")).getText(), x + 5, y + 5 + 10, 16777215);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int p_mouseClicked_5_)
    {
        ...
        if ((profile != null && profile.isOnline()) && mouseX >= listWidth - stringWidth - 4 && mouseX <= listWidth - 5 && mouseY - yTop >= 0 && mouseY - yTop <= 7)
        {
