...
//
//    @SidedProxy(clientSide = "net.creeperhost.minetogether.proxy.ClientProxy", serverSide = "net.creeperhost.minetogether.proxy.ServerProxy")
...
//            {
//                className = "net.creeperhost.minetogether.server.hacky.OldPlayerKicker";
//            }
//
//            try
//            {
