...
public class GuiOffline extends GuiScreen
{
    ...
    public GuiOffline(GuiScreen parent)
    {
        this.parent = parent;
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        {
            if(ignored) offline.createNewFile();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(fontRendererObj, "MineTogether is in offline mode", width / 2, 10, -1);
        int start = 30;
    ...
    public void initGui()
    {
        ...
        if (component == null) component = new TextComponentString("");

        component.appendSibling(new TextComponentString(currentText.substring(lastEnd)));

        String checkboxDisplayString = "Do not show this screen again";

        gdprlines = GuiUtilRenderComponents.splitText(component, width - 10, fontRendererObj, false, true);
        this.buttonList.add(acceptButton = new GuiButton(8008, (width / 2) - 40, height - 40, 80, 20, "Continue"));
        checkBox = new GuiCheckBox(2, (width / 2) - (fontRendererObj.getStringWidth(checkboxDisplayString) / 2), height - 52, checkboxDisplayString, ignored);
