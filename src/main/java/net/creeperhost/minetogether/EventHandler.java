    ...
    public void guiOpen(GuiOpenEvent event)
    {
        ...
        if (gui instanceof DisconnectedScreen)
        {
            ...
            try
            {
                ...
                {
                    event.setGui(new GuiProgressDisconnected((Screen) parentField.get(dc), reason, message, lastNetworkManager));
        ...
        } else if (gui instanceof ChatScreen && Config.getInstance().isChatEnabled() && !CreeperHost.instance.ingameChat.hasDisabledIngameChat())
        {
            String presetString = "";
            boolean sleep = false;
            ...
            try
            {
                ...
                {
                    firstOpen = false;
                    ((GuiNewChatOurs)Minecraft.getInstance().ingameGUI.getChatGUI()).setBase(!CreeperHost.instance.gdpr.hasAcceptedGDPR());
                }
