...
public class ServerListGui implements GuiProvider {
    ...
    public void buildGui(ModularGui gui) {
        ...
        gui.setGuiTitle(new TranslatableComponent("minetogether:gui.server_list.title"));
        ...
        GuiButton communityBtn = MTStyle.Flat.button(root, new TranslatableComponent("minetogether:gui.server_list.type.community"))
                .setTooltip(new TranslatableComponent("minetogether:gui.server_list.type.community.info"))
        ...
        GuiButton publicBtn = MTStyle.Flat.button(root, new TranslatableComponent("minetogether:gui.server_list.type.public"))
                .setTooltip(new TranslatableComponent("minetogether:gui.server_list.type.public.info"))
        ...
        GuiButton closedBtn = MTStyle.Flat.button(root, new TranslatableComponent("minetogether:gui.server_list.type.closed"))
                .setTooltip(new TranslatableComponent("minetogether:gui.server_list.type.closed.info"))
        ...
        searchField = new GuiTextField(searchBg)
                ...
                .setSuggestion(new TranslatableComponent("minetogether:gui.server_list.search"));
        Constraints.bind(searchField, searchBg, 0, 3, 0, 3);

        GuiButton refreash = MTStyle.Flat.button(root, new TranslatableComponent("minetogether:gui.button.refresh"))
        ...
        GuiButton join = MTStyle.Flat.buttonPrimary(root, new TranslatableComponent("minetogether:gui.server_list.join"))
        ...
        GuiButton sort = MTStyle.Flat.button(root, () -> new TranslatableComponent("minetogether:gui.server_list.sort_by").append(" ").append(sorting.translate()))
    ...
    private void addTypeInfo(GuiElement<?> background) {
        GuiText last = new GuiText(background, new TranslatableComponent("minetogether:gui.server_list.type.select").withStyle(ChatFormatting.UNDERLINE))
        ...
        last = new GuiText(background, new TranslatableComponent("minetogether:gui.server_list.type.public.info"))
                .setEnabled(() -> serverType == NONE)
                .setWrap(true)
                .constrain(LEFT, relative(background.get(LEFT), 5))
                .constrain(RIGHT, relative(background.get(RIGHT), -5))
        ...
        last = new GuiText(background, new TranslatableComponent("minetogether:gui.server_list.type.community.info"))
                .setEnabled(() -> serverType == NONE)
                .setWrap(true)
                .constrain(LEFT, relative(background.get(LEFT), 5))
                .constrain(RIGHT, relative(background.get(RIGHT), -5))
        ...
        last = new GuiText(background, new TranslatableComponent("minetogether:gui.server_list.type.closed.info"))
                .setEnabled(() -> serverType == NONE)
                .setWrap(true)
                .constrain(LEFT, relative(background.get(LEFT), 5))
                .constrain(RIGHT, relative(background.get(RIGHT), -5))
