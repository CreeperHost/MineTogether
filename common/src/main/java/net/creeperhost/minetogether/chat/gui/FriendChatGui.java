...
public class FriendChatGui implements GuiProvider {
    ...
    private void tickFriendList() {
        ...
        if (!requests.isEmpty()) {
            friendList.add(new FriendElement(friendList, (Profile) null).setDivider(new TranslatableComponent("minetogether:gui.friends.requests").withStyle(ChatFormatting.UNDERLINE)));
        ...
        if (!groupInvites.isEmpty()) {
            friendList.add(new FriendElement(friendList, (Profile) null).setDivider(new TranslatableComponent("minetogether:gui.friends.group.invites").withStyle(ChatFormatting.UNDERLINE)));
    ...
    private void updateSelected() {
        ...
        if (selected != null && state == IrcState.CONNECTED) {
            ...
            textField.setSuggestion(new TranslatableComponent("minetogether:gui.friends.group.channel_waiting"));
        } else {
            chatMonitor.attach(null);
