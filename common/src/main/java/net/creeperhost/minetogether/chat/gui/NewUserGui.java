...
public class NewUserGui implements GuiProvider {
    ...
    public void buildGui(ModularGui gui) {
        ...
        for (int i = 1; i < 5; i++) {
            last = new GuiText(root, new TranslatableComponent("minetogether:new_user." + i, i == 4 ? new Object[]{ChatStatistics.userCount} : new Object[0]))
        ...
        GuiButton join = MTStyle.Flat.button(root, () -> new TranslatableComponent("minetogether:gui.join.button.accept", ChatStatistics.onlineCount))
                .onPress(() -> {
        ...
        GuiButton reject = MTStyle.Flat.buttonCaution(root, new TranslatableComponent("minetogether:gui.join.button.reject"))
                .onPress(() -> {
