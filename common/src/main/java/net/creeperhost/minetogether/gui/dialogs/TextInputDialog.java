...
public class TextInputDialog extends GuiElement<TextInputDialog> implements BackgroundRender {
    ...
    public TextInputDialog(@NotNull GuiParent<?> parent, Component title, String defaultText) {
        ...
        okButton = GuiButton.flatColourButton(this, () -> Component.translatable("minetogether:gui.button.ok"), hovered -> hovered ? 0xFF44AA44 : 0xFF118811)
                .onPress(this::accept)
        ...
        cancelButton = GuiButton.flatColourButton(this, () -> Component.translatable("minetogether:gui.button.cancel"), hovered -> hovered ? 0xFFAA4444 : 0xFF881111)
                .onPress(this::close)
                .constrain(TOP, relative(textBg.get(BOTTOM), 3))
