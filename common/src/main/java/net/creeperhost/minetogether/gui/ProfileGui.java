...
public class ProfileGui implements GuiProvider {
    ...
    public void buildGui(ModularGui gui) {
        ...
        gui.setGuiTitle(new TranslatableComponent("minetogether:gui.profile.title"));
        ...
        GuiText nameTitle = new GuiText(root, new TranslatableComponent("minetogether:gui.profile.display_name").withStyle(ChatFormatting.UNDERLINE))
        ...
        GuiButton nameButton = MTStyle.Flat.buttonPrimary(root, new TranslatableComponent("minetogether:gui.profile.button." + (premium ? "save" : "change")))
...
//                .setAlignment(Align.LEFT)
        ...
        GuiText canChange = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.name_can_be_changed").withStyle(ChatFormatting.GRAY))
                .setEnabled(ProfileRequests::canChangeName)
                .constrain(WIDTH, literal(uiWidth))
                .autoHeight();
        ...
        feedbackElement.addMessage(new TranslatableComponent("minetogether:gui.profile.fetching_data").withStyle(ChatFormatting.GRAY));
    ...
    private void buildNameSelectionScreen(GuiElement<?> uiRoot, int uiWidth) {
        ...
        GuiText title = new GuiText(root, new TranslatableComponent("minetogether:gui.profile.choose_name").withStyle(ChatFormatting.UNDERLINE))
        ...
        GuiButton save = MTStyle.Flat.buttonPrimary(root, new TranslatableComponent("minetogether:gui.profile.button.save"))
                .onPress(() -> {
        ...
        GuiButton randomize = MTStyle.Flat.button(root, new TranslatableComponent("minetogether:gui.profile.button.randomize"))
        ...
        GuiButton cancel = MTStyle.Flat.buttonCaution(root, new TranslatableComponent("minetogether:gui.button.cancel"));
    ...
    private void buildBanScreen(GuiElement<?> uiRoot, int uiWidth) {
        ...
        GuiText youAreBanned = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.you_are_banned").withStyle(ChatFormatting.RED))
                .constrain(WIDTH, literal(uiWidth))
                .setWrap(true)
                .autoHeight();
        Constraints.placeInside(youAreBanned, root, Constraints.LayoutPos.TOP_CENTER, 0, 20);

        GuiText currentBan = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.current_ban").withStyle(ChatFormatting.RED, ChatFormatting.UNDERLINE))
                .constrain(WIDTH, literal(uiWidth))
                .setWrap(true)
                .autoHeight();
        Constraints.placeOutside(currentBan, youAreBanned, Constraints.LayoutPos.BOTTOM_CENTER, 0, 10);

        GuiText banId = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.ban_id", ProfileRequests.getBanId().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.YELLOW))
                .constrain(WIDTH, literal(uiWidth))
                .setAlignment(Align.LEFT)
                .setWrap(true)
                .autoHeight();
        ...
        GuiText moderator = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.moderator", ProfileRequests.getModerator().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.YELLOW))
                .constrain(WIDTH, literal(uiWidth))
                .setAlignment(Align.LEFT)
                .setWrap(true)
                .autoHeight();
        ...
        GuiText reason = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.reason", ProfileRequests.getReason().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.YELLOW))
                .constrain(WIDTH, literal(uiWidth))
                .setAlignment(Align.LEFT)
                .setWrap(true)
                .autoHeight();
        ...
        GuiText timeStamp = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.timestamp", ProfileRequests.getTimestamp().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.YELLOW))
                .constrain(WIDTH, literal(uiWidth))
                .setAlignment(Align.LEFT)
                .setWrap(true)
                .autoHeight();
        ...
        GuiText appealStatus = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.appeal_status", ProfileRequests.getAppealStatus().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.BLUE))
                .constrain(WIDTH, literal(uiWidth))
                .setAlignment(Align.LEFT)
                .setWrap(true)
                .autoHeight();
        ...
        GuiText appealNotes = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.appeal_notes").withStyle(ChatFormatting.GOLD, ChatFormatting.UNDERLINE))
        ...
        GuiText nextAppeal = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.next_appeal", ProfileRequests.getNextAppealComp().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.YELLOW))
        ...
        GuiText submitAppeal = new GuiText(root, () -> new TranslatableComponent("minetogether:gui.profile.ban.submit_an_appeal").withStyle(ChatFormatting.BLUE))
                .constrain(WIDTH, literal(uiWidth))
                .setWrap(true)
                .autoHeight();
