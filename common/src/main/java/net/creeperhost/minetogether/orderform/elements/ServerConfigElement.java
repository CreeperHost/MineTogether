...
public class ServerConfigElement extends GuiElement<ServerConfigElement> {
    ...
    public ServerConfigElement(@NotNull GuiParent<?> parent, OrderGui gui) {
        ...
        GuiElement<?> lastElement = new GuiText(this, new TranslatableComponent("minetogether:gui.order.configure").withStyle(ChatFormatting.UNDERLINE, ChatFormatting.GOLD))
        ...
        //Server Name
        lastElement = new GuiText(this, new TranslatableComponent("minetogether:gui.order.server_name"))
                .setAlignment(Align.LEFT)
        ...
        GuiButton randomise = MTStyle.Flat.button(this, new TranslatableComponent("minetogether:gui.order.button.randomize"))
        ...
        //Player Count
        lastElement = new GuiText(this, new TranslatableComponent("minetogether:gui.order.player_count"))
                .setAlignment(Align.LEFT)
                .constrain(TOP, relative(lastElement.get(BOTTOM), 5))
                .constrain(LEFT, match(get(LEFT)))
                .constrain(RIGHT, midPos)
        ...
        for (int i = 0; i < 5; i++) {
            int finalI = i;
            int count = 5 + (i * 5);
            MTStyle.Flat.button(this, new TextComponent(String.valueOf(count)))
        ...
        lastElement = new GuiText(this, playerCountInfo)
                ...
                .constrain(LEFT, match(get(LEFT)))
                .constrain(RIGHT, match(get(RIGHT)));
        lastElement.constrain(HEIGHT, dynamic(() -> (double) this.font().wordWrapHeight(playerCountInfo.getString(), (int) xMax() - (int) xMin())));
