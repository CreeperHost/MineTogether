...
import net.creeperhost.minetogetherlib.serverorder.RegexValidator;
...
public class PersonalDetailsScreen extends OrderServerScreen
{
    ...
    public void init()
    {
        ...
        this.list = new ScreenList(this, this.minecraft, this.width, this.height, 56, this.height - 36, 36);
