...
public class GuiShareToFriends implements GuiProvider {
    ...
    public void buildGui(ModularGui gui) {
        ...
        gameModeButton.getLabel().setTextSupplier(() -> Component.translatable("selectWorld.gameMode").append(": ").append(gameMode.getShortDisplayName()));

        GuiButton cheatsButton = MTStyle.Flat.button(root, Component.empty())
...
//        slider.setEnableToolTip(() -> !slider.isDragging());
        ...
        GuiText getPlayersError = new GuiText(root, Component.translatable("minetogether.connect.open.max_players_error").withStyle(ChatFormatting.RED))
        ...
        GuiButton cancelButton = MTStyle.Flat.button(root, Component.translatable("gui.cancel"))
